...
module.exports = exports = function pagedFindPlugin (schema) {
    /*
        It implements paginated find for a set instances of a specific model
    */
  schema.statics.pagedFind = function(options, cb) {
    ...
    //count retrieved results using all filters received
    ...
    //retrieve results using all filters received like query, skip, limit and sorting 
