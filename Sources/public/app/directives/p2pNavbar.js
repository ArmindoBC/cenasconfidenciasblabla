 ...
 */
app.directive('p2pNavbar',["$location", "$sessionStorage","UserService",  function ($location, $sessionStorage, UserService) {
    return {
        ...
        templateUrl: 'app/views/directives/p2pNavbar.html',
