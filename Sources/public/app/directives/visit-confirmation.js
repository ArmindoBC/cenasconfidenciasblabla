 ...
 */
app.directive('visitConfirmation',["$location", "$sessionStorage","UserService",  function ($location, $sessionStorage, UserService) {
    return {
        ...
        templateUrl: 'app/views/directives/visit-confirmation.html',
